...
var user_roles_enum_1 = require("../../db/migrations/user-roles.enum");
var UserEntity = function () {
    ...
    (function () {
        ...
        _roles_decorators = [(0, typeorm_1.Column)({ type: 'enum', enum: user_roles_enum_1.Roles, default: user_roles_enum_1.Roles.USER })];
