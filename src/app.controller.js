...
var AppController = function () {
    var _classDecorators = [(0, common_1.Controller)('app')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getHello_decorators;
    var _gethi_decorators;
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.gethi = function () {
            return this.appService.getHello();
        };
    ...
    (function () {
        ...
        _gethi_decorators = [(0, common_1.Post)('hi')];
        ...
        __esDecorate(_classThis, null, _gethi_decorators, { kind: "method", name: "gethi", static: false, private: false, access: { has: function (obj) { return "gethi" in obj; }, get: function (obj) { return obj.gethi; } }, metadata: _metadata }, null, _instanceExtraInitializers);
